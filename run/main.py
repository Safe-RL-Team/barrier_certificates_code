...
class Crabs:
    ...
    def _task_pretrain_model(self):
                # collect 20_000 samples
        # self.evaluate("pre-run", 20_000)
        self.explore(self.policy, 20_000, True)
        self.train_models(epochs=20)
        self.save_model("init_model.pt")
